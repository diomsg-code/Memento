...
L["general.options.encounter.victory.scenario.name"] = "Szenario"
L["general.options.encounter.victory.scenario.desc"] = "Aktiviere oder deaktiviere die automatische Erstellung eines Screenhots, wenn ein Szenario Boss besiegt wurde."
...
L["general.options.encounter.wipe.scenario.name"] = "Szenario"
L["general.options.encounter.wipe.scenario.desc"] = "Aktiviere oder deaktiviere die automatische Erstellung eines Screenhots, wenn bei einem Szenario Boss ein Wipe stattgefunden hat."
