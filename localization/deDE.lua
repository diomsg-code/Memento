...
L["general.options.encounter"] = "Boss besiegt"
L["general.options.encounter.party.name"] = "Dungeon"
L["general.options.encounter.party.desc"] = "Aktiviere oder deaktiviere die automatische Erstellung eines Screenhots, wenn ein Dungeon Boss besiegt wurde."
L["general.options.encounter.raid.name"] = "Raid"
L["general.options.encounter.raid.desc"] = "Aktiviere oder deaktiviere die automatische Erstellung eines Screenhots, wenn ein Raid Boss besiegt wurde."
L["general.options.encounter.scenario.name"] = "Szenario"
L["general.options.encounter.scenario.desc"] = "Aktiviere oder deaktiviere die automatische Erstellung eines Screenhots, wenn ein Szenario Boss besiegt wurde."
L["general.options.encounter.first.name"] = "nur der erste Sieg pro Schwierigkeit"
L["general.options.encounter.first.desc"] = "Aktiviere oder deaktiviere die automatische Erstellung eines Screenhots, wenn ein Boss besiegt wurde. Diese Option gilt für jede Schwierigkeit getrennt."
L["general.options.encounter.timer.name"] = "Verzögerung"
L["general.options.encounter.timer.desc"] = "Zeitliche Verzögerung des Screenshots, nachdem ein Boss besiegt wurde.\n\nStandard: 2 Sekunden"
...
L["chat.events.encounter.new"] = "Screenshot erstellt - Boss besiegt: "
...
L["chat.statistic.encounter"] = "Boss besiegt"
