...
L["options.setting.death"] = "Spielertod"
L["options.setting.death.active.name"] = "Screenshot bei Spielertod erstellen"
L["options.setting.death.active.desc"] = "Aktiviere oder deaktiviere die automatische Erstellung eines Screenhots, wenn der Spieler gestorben ist."
L["options.setting.death.timer.name"] = "Verzögerung"
L["options.setting.death.timer.desc"] = "Zeitliche Verzögerung des Screenshots, nachdem der Spieler gestorben ist.\nStandard: 1 Sekunde"
